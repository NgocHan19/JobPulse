      ...
      <div className="absolute w-[1200px] h-[50px] left-[180px] bg-white rounded-[30px] flex items-center justify-between top-[50%] transform -translate-y-1/2 px-5 gap-5">
        ...
        <div className="relative" ref={locationRef}>
          ...
          {showLocationDropdown && (
            <div className="absolute left-0 mt-2 w-full bg-white border rounded-lg shadow-lg max-h-[200px] overflow-y-auto z-50 pointer-events-auto">
        ...
        <button className="w-[150px] h-[40px] bg-[#1A73E8] rounded-[20px] flex items-center justify-center gap-2 ml-auto">
