...
function Header() {
  ...
  return (
    <div className="relative ">
      ...
      {showJobApplication && (
        <div className="absolute w-[250px] h-[250px] left-[350px] top-[70px] bg-white rounded-md shadow-lg mt-2 z-10">
          <div className="absolute w-[250px] h-[250px] bg-white rounded-md">
            <div className="absolute w-[220px] h-[40px] bg-[#F1F3F4] rounded-md top-[15px] left-[15px] flex items-center px-2">
            ...
            <div className="absolute w-[220px] h-[40px] bg-[#F1F3F4] rounded-md top-[75px] left-[15px] flex items-center px-2">
            ...
            <div className="absolute w-[220px] h-[40px] bg-[#F1F3F4] rounded-md top-[135px] left-[15px] flex items-center px-2">
            ...
            <div className="absolute w-[220px] h-[40px] bg-[#F1F3F4] rounded-md top-[195px] left-[15px] flex items-center px-2">
      ...
      {showCVManagement && (
        <div className="absolute w-[200px] h-[190px] left-[600px] top-[70px] bg-white rounded-md shadow-lg mt-2 z-10">
          <div className="absolute w-[200px] h-[190px] bg-white rounded-md">
            <div className="absolute w-[170px] h-[40px] bg-[#F1F3F4] rounded-md top-[15px] left-[15px] flex items-center px-2">
            ...
            <div className="absolute w-[170px] h-[40px] bg-[#F1F3F4] rounded-md top-[75px] left-[15px] flex items-center px-2">
            ...
            <div className="absolute w-[170px] h-[40px] bg-[#F1F3F4] rounded-md top-[135px] left-[15px] flex items-center px-2">
      ...
      {showCompanyManagement && (
        <div className="absolute w-[220px] h-[130px] left-[800px] top-[70px] bg-white rounded-md shadow-lg mt-2 z-10">
          <div className="absolute w-[220px] h-[130px] bg-white rounded-md">
            <div className="absolute w-[190px] h-[40px] bg-[#F1F3F4] rounded-md top-[15px] left-[15px] flex items-center px-2">
            ...
            <div className="absolute w-[190px] h-[40px] bg-[#F1F3F4] rounded-md top-[75px] left-[15px] flex items-center px-2">
