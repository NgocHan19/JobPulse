            ...
            <div className="absolute w-[600px] h-[510px] left-[60px] top-[50px]">
              <div className="relative w-[900px] h-[900px] bg-white rounded-[10px]">
                ...
                <div className="flex absolute left-[40px] top-[160px] space-x-4 gap-8">
                    ...
                    {/* Danh sách công việc */}
                    <div className="absolute left-[40px] top-[220px] right-[40px] bottom-[10px] overflow-y-auto max-h-[800px]">
                ...
                <div className="absolute left-[950px] h-[800px] top-0 overflow-y-auto">
                    <div className="flex flex-col space-y-4">
                        <div className="relative w-[400px] h-[900px] bg-white rounded-[10px]">
                            <div className="absolute w-[264px] h-[29px] left-4 top-4 font-bold text-2xl leading-[29px] text-black">
                                Gợi ý việc làm phù hợp
                            </div>

                            {[1, 2, 3, 4].map((_, index) => (
                            <div className="relative w-[360px] h-[110px] left-5 top-[50px] my-2 max-h-[800px]" key={index}>
                                <div className="box-border w-full h-full bg-white border border-[#F2F0F0] rounded-[5px] p-4 flex items-center">
                                    ...
                                    <div className="flex flex-col items-start">
                                        ...
                                        <div className="flex mt-2">
                                            <div className="bg-[#D9D9D9] w-[80px] rounded-[5px] p-1 text-black mr-2 flex items-center justify-center">Giá</div>
                                            <div className="bg-[#D9D9D9] w-[100px]  rounded-[5px] p-1 text-black flex items-center justify-center">Địa điểm</div>
                                        </div>
                                    </div>
                                    <img 
                                        src={images['icon_heart_blue.png']}
                                        alt=".." 
                                        className="absolute right-2 bottom-2 w-[20px] h-[20px]" 
                                    />
                                </div>
                            </div>
                        ))}
